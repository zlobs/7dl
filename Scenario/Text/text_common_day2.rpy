...
label alt_day2_slot_sl:
    ...
    $ set_mode_nvl()
    if herc:
        "Мне {image=alt_KS_censor}… Белые питерские ночи, я сижу на подоконнике своей квартиры, выходящей окнами на бывшую церковь, из которой Советская Власть сделала бассейн."
